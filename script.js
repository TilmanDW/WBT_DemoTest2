...
async function processText(operation) {
    ...
    if (inputText.length > 6000) {
        if (!confirm('Your text is quite long and will be truncated to 6000 characters. Continue?')) {
            return;
        }
    }
    ...
    try {
        ...
        if (data.source === 'Mistral AI') {
            console.log('✅ Response generated by Mistral AI');
        } else {
            console.log('📝 Response generated by demo mode');
        }
        ...
        document.getElementById('outputText').innerHTML = `
            <div style="color: #e74c3c; padding: 20px; background: #ffeaa7; border-radius: 8px; border-left: 4px solid #e74c3c;">
                ...
                Unable to process your request at the moment. This could be due to:<br>
                • High server load<br>
